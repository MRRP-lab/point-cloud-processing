# If set up with RGBD camera, you can record and save the video files into an external folder 
...
with OakCamera() as oak:
    color = oak.create_camera('color', resolution='1080P', encode='mjpeg', fps=FPS)
